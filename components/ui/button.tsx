...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-semibold transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:bg-neutral-100 disabled:from-neutral-100 disabled:to-neutral-100 disabled:text-neutral-600 border border-neutral-200 shadow-sm",
  {
    variants: {
      variant: {
        primary:
          "bg-gradient-to-b from-[#0077b6] to-[#023e8a] text-primary-foreground hover:from-[#023e8a] hover:to-[#023e8a]",
        destructive:
        ...
        teritary: "bg-blue-100 text-blue-700 border-transparent hover:bg-blue-200 shadow-none"
      },
      size: {
